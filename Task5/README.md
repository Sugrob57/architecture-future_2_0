...
> [!NOTE] 
> Расходы указаны для примера (реальных данных не известно)
...
|-----|---------|
| Серверы + железо | 800k | 
| Лицензии (SQL Server, BI) | 600k | 
| Поддержка legacy | 700k | 
| ETL / аналитика (люди) | 900k | 
| Итого | 3.0M / год |
...
| Статья | Стоимость | 
|-----|---------|
| Cloud (compute + storage) | 1.2M | 
| Kafka / streaming | 300k | 
| Data platform | 400k | 
| Поддержка | 500k | 
| Аналитика (меньше времени) | 500k | 
| Итого | 2.9M / год | 

#### 3. Динамика за 3 года

| Год | Текущая | Целевая | 
|-----|---------|-----------|
| 1 | 3.0M | 3.5M (инвестиции) | 
| 2 | 3.2M | 3.0M | 
| 3 | 3.5M | 2.7M | 
